...
if __name__ == "__main__":
    # Processa i tre file separatamente per mantenere la separazione tra
    # famiglie modello e pack associati:
    #   V21E -> MSV4/MSV4S/MSV4PP  -> Touring Pack standard  (Mappatura - Copia.xlsx)
    #   V22E -> MSV4RI (Rally)      -> Touring Pack Rally     (Mappatura Rally.xlsx)
    #   V24T -> MSV4RS (RS)         -> nessun touring pack    (Mappatura RS.xlsx)
    # Processando separatamente si evita che Touring Pack e Touring Pack Rally
    # risultino entrambi attivi nella stessa riga (sarebbero mutuamente esclusivi).
    _input_files = [
        ".\\Input\\matrix_output_V21E.xlsx",
        ".\\Input\\matrix_output_V22E.xlsx",
        ".\\Input\\matrix_output_V24T.xlsx",
    ]
